...
async function main() {
    ...
    setInterval(async () => {
        ...
        try {
            const response = await fetch(`https://steamcommunity.com/market/itemordershistogram?country=DE&language=german&currency=3&item_nameid=${trackedItem.id}&two_factor=0`, options);
